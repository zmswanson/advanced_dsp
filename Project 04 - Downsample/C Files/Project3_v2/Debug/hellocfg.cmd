...
_KNL_swi = KNL_swi;
_TSK_idle = TSK_idle;
_TSKDecimate = TSKDecimate;
_TSKPingPong = TSKPingPong;
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .TSKDecimate$stk: block(0x20000){
            *(.TSKDecimate$stk)
        } > DARAM PAGE 0

        .TSKPingPong$stk: block(0x20000){
            *(.TSKPingPong$stk)
        } > DARAM PAGE 0
       ...
       .hst0: block(0x20000) align = 0x4 {} > DARAM PAGE 0
        ...
        .MBXDecimate$que: block(0x20000) align = 0x4 {
            MBXDecimate$queElems = .;
            . += 1160;
        } > DARAM PAGE 0
